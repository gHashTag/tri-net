...
## Clock: 200 MHz differential, DIFF_SSTL15, clk_p on R4 (per docs/issues-archive
...
## clk_n is R4's differential mate on the same bank -- VERIFY the exact pin against the
...
create_clock -period 5.000 -name sysclk [get_ports clk_p]   ## 200 MHz
