...
- **Кремний** — изготовленного кристалла не существует, изготовление не запланировано, прежний маршрут закрыт. Никогда не заявляй ни returned, ни pending, ни сроков: пруфа нет ни у одного из этих утверждений.
