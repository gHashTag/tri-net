...
// NOT LOWERED BY THIS BACKEND: 12 test(s), 0 invariant(s).
...
pub fn create_2node_mesh(quality: u8) -> (u32, u32) {
    return (
        create_link_quality(NODE_1, NODE_2, quality),
...
pub fn create_3node_mesh(q12: u8, q23: u8, q31: u8) -> (u32, u32, u32) {
    return (
        create_link_quality(NODE_1, NODE_2, q12),
        ...
        if (topology == 3) {
            ...
            if (topology == 4) {
                if (((((((from == NODE_1) && (to == NODE_2))
                    ...
                    || ((from == NODE_4) && (to == NODE_3)))
                {
                    return 1;
                } else {
                    if (((from == NODE_1) && (to == NODE_3))
                        || ((from == NODE_3) && (to == NODE_1)))
                    {
                        return 2;
                    } else {
                        if (((from == NODE_2) && (to == NODE_4))
                            || ((from == NODE_4) && (to == NODE_2)))
                        {
                            return 2;
                        } else {
                            if (((from == NODE_1) && (to == NODE_4))
