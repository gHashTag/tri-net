...
pub fn create_sample(value: u32, timestamp: u32, sequence: u32, valid: u32) -> u32 {
    return (((((value & 0xFF) << 24) | ((timestamp & 0xFF) << 16)) | ((sequence & 0xFF) << 8))
        | (valid & 0x1));
}
...
pub fn create_pattern_storage(
    samples: u32,
    pattern_count: u32,
    trend: u32,
    last_update: u32,
) -> u32 {
    return (((((samples & 0xFFFF) << 16) | ((pattern_count & 0xFF) << 8)) | (trend & 0x3))
        | (last_update & 0x1));
}
