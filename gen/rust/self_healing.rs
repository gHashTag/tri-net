...
pub fn create_recovery_state(
    ...
    return (((((attempts & 0xF) << 28) | ((last_attempt & 0xFFFF) << 12))
        | ((in_progress & 0x1) << 8))
        | (success_count & 0xFF));
}
...
pub fn create_network_state(
    healthy_nodes: u32,
    total_nodes: u32,
    degraded_links: u32,
    total_links: u32,
) -> u32 {
    return (((((healthy_nodes & 0xFF) << 24) | ((total_nodes & 0xFF) << 16))
...
pub fn update_network_after_recovery(
    network_state: u32,
    nodes_recovered: u32,
    links_restored: u32,
) -> u32 {
