...
#ifndef TRINETVIDEO_SWIFT_H
#define TRINETVIDEO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TriNetVideo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11TriNetVideo18CallKitCoordinator")
@interface CallKitCoordinator : NSObject <CXProviderDelegate, PKPushRegistryDelegate>
...
SWIFT_CLASS("_TtC11TriNetVideo16CameraController")
...
@class LiveKitError;
SWIFT_CLASS("_TtC11TriNetVideo22InternetCallController")
@interface InternetCallController : NSObject <RoomDelegate>
...
@class NSNetService;
SWIFT_CLASS("_TtC11TriNetVideo21MeshNicknameDirectory")
@interface MeshNicknameDirectory : NSObject <NSNetServiceBrowserDelegate, NSNetServiceDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
@class NSCoder;
SWIFT_CLASS("_TtC11TriNetVideo11PreviewView")
...
@class UIApplication;
SWIFT_CLASS("_TtC11TriNetVideo17TriNetAppDelegate")
@interface TriNetAppDelegate : NSObject <UIApplicationDelegate>
- (BOOL)application:(UIApplication * _Nonnull)application didFinishLaunchingWithOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC11TriNetVideo16VideoDisplayView")
