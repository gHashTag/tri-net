...
@interface AudioSessionConfiguration (SWIFT_EXTENSION(LiveKit))
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) AudioSessionConfiguration * _Nonnull soloAmbient;)
+ (AudioSessionConfiguration * _Nonnull)soloAmbient SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) AudioSessionConfiguration * _Nonnull playback;)
+ (AudioSessionConfiguration * _Nonnull)playback SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) AudioSessionConfiguration * _Nonnull playAndRecordSpeaker;)
+ (AudioSessionConfiguration * _Nonnull)playAndRecordSpeaker SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) AudioSessionConfiguration * _Nonnull playAndRecordReceiver;)
+ (AudioSessionConfiguration * _Nonnull)playAndRecordReceiver SWIFT_WARN_UNUSED_RESULT;
@end
...
+ (LocalVideoTrack * _Nonnull)createBroadcastScreenCapturerTrackWithName:(NSString * _Nonnull)name source:(enum TrackSource)source options:(ScreenShareCaptureOptions * _Nonnull)options reportStatistics:(BOOL)reportStatistics SWIFT_WARN_UNUSED_RESULT;
@end
