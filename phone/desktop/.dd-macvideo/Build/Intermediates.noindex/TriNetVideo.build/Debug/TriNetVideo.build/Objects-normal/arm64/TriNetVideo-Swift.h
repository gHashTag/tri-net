...
SWIFT_CLASS("_TtC11TriNetVideo13CameraCapture")
...
@class SCStream;
SWIFT_CLASS("_TtC11TriNetVideo13ScreenCapture") SWIFT_AVAILABILITY(macos,introduced=12.3)
@interface ScreenCapture : NSObject <SCStreamOutput>
- (void)stream:(SCStream * _Nonnull)stream didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sb ofType:(SCStreamOutputType)type;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
